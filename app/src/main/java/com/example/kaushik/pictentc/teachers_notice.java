...
public class teachers_notice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonChooseImage =findViewById(R.id.tln_select_file);
        mButtonUpload = findViewById(R.id.tln_upload_file);
        mEditTextFileName = findViewById(R.id.tln_file_name);
        mImageView = findViewById(R.id.image_view);
        mProgressBar = findViewById(R.id.progress_bar_tln);
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(teachers_notice.this, "Upload successful", Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(teachers_notice.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
